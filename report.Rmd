...
```{r, echo=FALSE, fig.cap='cv_varsel function output', fig.align='center', fig.pos="H", out.width = '80%'}
...
```{r, echo=FALSE, fig.cap='solution_terms function output', fig.align='center', fig.pos="H", out.width = '80%'}
...
The formula is the one stated above, and includes the 3 best ranked predictive variables and the target.
...
do.call(grid.arrange, c(p[1:3], ncol=1, nrow=3))
```
