...
```{r, echo=FALSE, fig.cap='densities for area_worst variable', fig.align='center', fig.pos="H", out.width = '70%'}
knitr::include_graphics('images/area_worst_densities.png')
```

```{r, echo=FALSE, fig.cap='densities for the smoothness_mean variable', fig.align='center', fig.pos="H", out.width = '70%'}
knitr::include_graphics('images/smoothness_mean_densities.png')
```

```{r, echo=FALSE, fig.cap='densities for the texture_mean variable', fig.align='center', fig.pos="H", out.width = '70%'}
